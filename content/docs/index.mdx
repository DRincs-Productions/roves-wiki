...
either a double-click-runnable portable executable or a real installer (`.msi`/`.dmg`/`.deb`)
for Windows, macOS, and Linux — with your content either sitting next to it or packed
